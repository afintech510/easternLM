...
create policy "Admin can insert products" on products for insert to authenticated with check (public.is_admin());
create policy "Admin can update products" on products for update to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "Admin can insert categories" on categories for insert to authenticated with check (public.is_admin());
create policy "Admin can update categories" on categories for update to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "Admin can update site_settings" on site_settings for update to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "Admin can insert truck_types" on truck_types for insert to authenticated with check (public.is_admin());
create policy "Admin can update truck_types" on truck_types for update to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "Admin can insert gallery_projects" on gallery_projects for insert to authenticated with check (public.is_admin());
create policy "Admin can update gallery_projects" on gallery_projects for update to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "Admin can update orders" on orders for update to authenticated using (public.is_admin()) with check (public.is_admin());
...
create policy "Admin can update accounts" on accounts for update to authenticated using (public.is_admin()) with check (public.is_admin());

-- Town pages: admin write access
create policy "Admin can insert town_pages" on town_pages for insert to authenticated with check (public.is_admin());
create policy "Admin can update town_pages" on town_pages for update to authenticated using (public.is_admin()) with check (public.is_admin());
